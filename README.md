...
# <div style="display:flex;justify-content:space-between;align-items:flex-end"> BassCase README <div style="display:inline-block;height:80px;width: 160px;"> ![BassCase](https://s3.amazonaws.com/basscase-dev/BASSCASE.png "BassCase") </div> </div>
